...
const ContactAntonia = styled.h3`
  color: white;
  // border: 3px double darkred;
  padding: auto;
`;

export const MainHeadingImpressum = styled.h1`
  text-align: center;
...
export default function Impressum() {
  return (
    <>
      ...
      <Navigation />
      <ImpressumContainer>
        <MainHeadingImpressum>Impressum</MainHeadingImpressum>

        <ContactAntonia>
          Webseite wurde erstellt von:
          <Antonia>Antonia Tandler, Junior Frontend Developerin</Antonia>
          Kontakt für Projekt-Anfragen, Feedback und Liebesbriefe:
          <Antonia>antonia@nightowls-audio.com</Antonia>
          Antonia ist verantwortlich für den Aufbau, die Funktionalität und das
          Design der Seite nach Angaben der Auftraggeber, nicht aber für die
          Inhalte.
        </ContactAntonia>
        <hr />
        ...
        <p>
          ...
          Event Agentur
          <br />
          Dehmelstra&szlig;e 22
          <br />
          18055 Rostock
        </p>
        <h2>Kontakt</h2>
        <p>
          Telefon: +49 0 178 6775776
          <br />
          Telefax: +49 0 178 6775776
          <br />
        ...
        <p>
          Die Gewerbeanmeldung nach &sect; 34c GewO wurde am 20.03.2017 durch
          Ordnungsamt Rostock erteilt.
        </p>
      ...
      <ImpressumContainer>
        ...
        <p>
          ...
          <br />
          Gro&szlig;e Burgstra&szlig;e 27/29
          <br />
          23552 L&uuml;beck
        </p>
